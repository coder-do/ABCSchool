...
namespace WebApi.Controllers
{
    ...
    public class RolesController : BaseApiController
    {
        ...
        {
            var response = await Sender.Send(new CreateRoleCommand { CreateRoleRequest = createRole });
        ...
        {
            var response = await Sender.Send(new UpdateRoleCommand { UpdateRoleRequest = updateRole });
            if (response.IsSuccessful)
            {
                return Ok(response);
            }
        ...
        {
            var response = await Sender.Send(new UpdateRolePermissionsCommand { UpdateRequest = updateRoleClaims });
            if (response.IsSuccessful)
            {
                return Ok(response);
            }
